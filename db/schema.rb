...
ActiveRecord::Schema.define(version: 20170506004159) do
  ...
  create_table "storytime_posts", force: :cascade do |t|
    ...
    t.integer  "blog_id"
    t.index "to_tsvector('english'::regconfig, (((COALESCE(title, ''::character varying))::text || ' '::text) || COALESCE(content, ''::text)))", name: "posts_title_contentx", using: :gin
